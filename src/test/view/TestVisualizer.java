...
public class TestVisualizer
{
	...
	public static void main(String[] args)
	{
		...
		Coordinate[] coord1 = { new Coordinate(900, 5), new Coordinate(100, 5), new Coordinate(100, 555),
				new Coordinate(200, 500), new Coordinate(400, 200), new Coordinate(900, 5), };
		VisualPolygon vp1 = new VisualPolygon(coord1);
		polygons.add(vp1);
		Coordinate[] coord2 = { new Coordinate(900, 500), new Coordinate(800, 550), new Coordinate(700, 555),
				new Coordinate(850, 600), new Coordinate(1000, 400), new Coordinate(900, 500), };
