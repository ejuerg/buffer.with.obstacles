...
public class NodePoint extends Coordinate {
	...
	public NodePoint(double x, double y, NodePoint prev, NodePoint next,
			Polygon p) {
		this(x, y);
	...
	public void setNextNode(NodePoint nextNode) {
		...
		if (nextNode.getNextNode() == null
				|| !nextNode.getNextNode().equals(this)) {
	...
	public void setPrevNode(NodePoint prevNode) {
		...
		if (prevNode.getNextNode() == null
				|| !prevNode.getNextNode().equals(this)) {
	...
	public boolean hasNeighbour(Coordinate other) {
		return (this.getPrevNode().equals2D(other) || this.getNextNode()
				.equals2D(other));
	}
